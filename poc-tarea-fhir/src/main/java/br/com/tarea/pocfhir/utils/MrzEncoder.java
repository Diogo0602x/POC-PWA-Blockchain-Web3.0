 ...
 * <p>
 * See
 * <a href="https://www.icao.int/publications/Documents/9303_p3_cons_en.pdf">Doc
 * 9303 - Machine Readable Travel Documents Seventh Edition, 2015 - Part 3:
 * Specifications Common to all MRTDs</a>.
 * </p>
 * 
...
public class MrzEncoder {
	 ...
	 * <p>
	 * This means removing all accents, mapping/expanding characters according to
	 * {@link #CHAR_MAPPINGS}, converting the string to uppercase, and finally to
	 * replace all spaces and non-supported characters with the '&lt;' char.
	 * </p>
	 * 
